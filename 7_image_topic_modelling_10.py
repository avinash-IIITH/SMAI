...
def main():
    ...
    lda_model = gensim.models.ldamodel.LdaModel.load('/home/avinash/Desktop/SMAI/DynamicLexiconGenerationCVC//DynamicLexiconGeneration/lda_model_10.lda', mmap='r')
    ###########################################################################################
    ...
    with open('/home/avinash/Desktop/SMAI/DynamicLexiconGenerationCVC/DynamicLexiconGeneration/training_label_10.json','w') as fp:
