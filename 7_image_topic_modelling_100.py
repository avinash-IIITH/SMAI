...
def main():
    ...
    lda_model = gensim.models.ldamodel.LdaModel.load('/home/avinash/Desktop/SMAI/DynamicLexiconGenerationCVC//DynamicLexiconGeneration/lda_model_100.lda', mmap='r')
    ###########################################################################################
    ...
    with open('/home/avinash/Desktop/SMAI/DynamicLexiconGenerationCVC/DynamicLexiconGeneration/training_label_100.json','w') as fp:
